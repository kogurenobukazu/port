...
public class CustomerDao extends BaseDao {
    ...
    public String add(CustomerBean customer) {
        ...
        String sql = "insert into customer(id, name, zip, address1, address2, tel, fax, email) values(SEQUENCE_CUSTOMER_ID.NEXTVAL,?,?,?,?,?,?,?)";
        PreparedStatement pstmt = null;
        String result = null;
    ...
    public String update(CustomerBean customer) {
        ...
        PreparedStatement pstmt = null;
        String sql = "UPDATE CUSTOMER SET NAME = ?, ZIP = ?, ADDRESS1 = ?, ADDRESS2 = ?, TEL = ?, FAX = ?, EMAIL = ? WHERE ID = ?";
        String result = null;
